...
class AgentManagerViewProvider implements vscode.WebviewViewProvider {
	...
	public updateAgents(agents: any[]) {
		if (this._view) {
			this._view.webview.postMessage({ type: 'updateAgents', agents: agents });
		}
	}
...
export function activate(context: vscode.ExtensionContext) {
	const provider = new AgentManagerViewProvider(context.extensionUri);
