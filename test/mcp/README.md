# AI IDE Development MCP Server

This directory contains a Model Context Protocol (MCP) server that provides Playwright browser automation capabilities for AI IDE development and testing. The MCP server exposes AI IDE's Playwright testing infrastructure through a standardized interface, allowing AI assistants and other tools to interact with browsers programmatically.
...
│   ├── playwright.ts        # AI IDE Playwright integration
...
- **AI IDE Integration**: Uses AI IDE's existing Playwright test infrastructure
...
### Server Won't Start
- Ensure AI IDE has been built and run at least once (via F5 or `code.sh`)
...
This MCP server is part of the AI IDE development infrastructure. When making changes:
